import { PiEye, PiPaintBrush, PiPlus } from "react-icons/pi";

export default function Dock() {
  return (
    <div className="lg:hidden dock dock-lg bg-secondary text-secondary-content">
      <button>
        <PiPlus size={22} />
      ...
      <button>
        ...
        <span className="dock-label">Design</span>
      </button>
    </div>
  );
}
